...
internal class XpPreferencesProvider : ContentProvider() {
    ...
    private fun setupUriMatcher() {
        ...
        val authority = "${context.packageName}.xpPreferencesProvider"
    ...
    private fun getPreferences(uri: Uri): SharedPreferences? {
        val name = uri.pathSegments.firstOrNull() ?: "XpPreferences"
